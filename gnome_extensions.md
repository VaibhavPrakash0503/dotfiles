# This file contains the list of gnome extensions
...
- **Dash to Dock** @micxgx(Gives a new kind of dash at the bottom.)
...
- **GSConnect** @andyholmes (Used with KDE Connect mobile app)
